...
namespace HtmlTags.Reflection
{
    public static class ReflectionExtensions
    {
        ...
        public static IEnumerable<T> GetAllAttributes<T>(this Accessor accessor) where T : Attribute => accessor.InnerProperty.GetCustomAttributes<T>();
        ...
        public static T GetAttribute<T>(this Accessor provider) where T : Attribute => provider.InnerProperty.GetCustomAttribute<T>();
        ...
        public static bool IsInteger(this Accessor accessor) => accessor.PropertyType.IsTypeOrNullableOf<int>() || accessor.PropertyType.IsTypeOrNullableOf<long>();
    }
}